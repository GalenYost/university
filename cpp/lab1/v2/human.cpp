...
Human::Human(const std::string &name, const std::string &surname, int age)
...
void Human::setName(const std::string &n) { name = n; };
void Human::setSurname(const std::string &sn) { surname = sn; };
void Human::setAge(int a) {
   if (a > 0 && a < 150)
      age = a;
};
void Human::setAge(std::string a) {
